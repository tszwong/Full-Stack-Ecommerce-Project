...
export class ProductListComponent implements OnInit {
  ...
  // new properties for pagination with some default values
  ...
  handleSearchProducts() {
    ...
    // if we have a different keyword than the previous, then set thePageNumber to 1
  ...
  handleListProducts() {
    ...
    this.productService.getProductListPaginate(
      ...
      this.thePageNumber-1,  // pagination components in angular are 1 based and spring data REST are 0 based
